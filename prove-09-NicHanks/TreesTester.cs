...
public static class TreesTester {
    ...
    public static void Run() {
        ...
        // TODO Problem 1
        tree.Insert(7);  //nick figure out duplicate
        tree.Insert(4);
        tree.Insert(10);
        tree.Insert(1);
        tree.Insert(6);
        ...
        Console.WriteLine(tree.Contains(6)); // True  //nick count how many there are
        ...
        Console.WriteLine("\n=========== PROBLEM 5 TESTS ===========");
        var tree1 = CreateTreeFromSortedList(new[] { 10, 20, 30, 40, 50, 60 }); // look for code to insert!
